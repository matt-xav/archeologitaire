...
public class Bomb extends Polygon {
	...
	public Bomb(int upperx, int uppery, int width) {
		super();//{upperx, upperx, upperx + width, upperx+width}, {uppery, uppery + width, uppery+width, uppery}, 4);
		xpoints[0] = upperx;
		xpoints[1] = upperx;
	...
	public boolean contains(Point p) {
		if(xpoints[0] <= (int) p.getX() && xpoints[2] >= (int) p.getX() && ypoints[0] <= (int) p.getY() && ypoints[2] >= (int) p.getY()) {
			return true;
		}
		return false;
	}
	...
	public String toString() {
		return String.format("Bomb:(%3d,%3d), (%3d,%3d), (%3d,%3d) , (%3d,%3d)", xpoints[0], ypoints[0], xpoints[1], ypoints[1], xpoints[2], ypoints[2], xpoints[3], ypoints[3]);
	}
}
